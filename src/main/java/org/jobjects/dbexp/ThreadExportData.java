...
public class ThreadExportData extends Thread {
  ...
  public ThreadExportData(String url, String username, String password, String fileAsc, String fileXml) {
    this.url = url;
  ...
  public void run() {
    ...
    try {
      ...
      rs.close();
      String[] tables = (String[]) listTables.toArray(new String[listTables.size()]);
