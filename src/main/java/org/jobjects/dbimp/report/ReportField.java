...
public class ReportField implements Reporting {
  ...
  /**
   * Method INFO_FIELD_UPDATED_IN_DB=| Le champ a pour valeur "{0}" dans le
   * fichier et a pour valeur "{1}" dans la base.
   * 
   * @param infile
   * @param indb
   */
  ...
  public void ERROR_FIELD_TYPE() {
    ...
    internalBuffer.append(
        RessourceReporting.getString("ERROR_FIELD_NUMERIC", new Object[] { field.getBuffer(), field.getTypeFormat().getTypeString() }));
    used = true;
  }

  /**
   * Method ERROR_FIELD_NUMERIC=| Le champ a pour valeur {0} n'est pas un
   * numérique du type {1}.
   */
  ...
  /**
   * Method ERROR_FIELD_VALUE_IN_LIST=| Le champ a pour valeur {0} et elle n
   * appartient pas à sa liste de valeur.
   */
  ...
  /**
   * Method ERROR_FIELD_MANDATORY=| !! Le champ est obligatoire alors qu'il y a
   * une valeur null ou vide. Ligne rejectée.
   * 
   * @return String
   */
  ...
  /**
   * Method ERROR_FIELD_NOT_IN_FILE=| Le champ est inaxessible. La ligne à une
   * longueur trop court.
   */
  ...
  /**
   * Method ERROR_FIELD_NOT_A_INTEGER=| La valeur {0} du champ n est pas un
   * entier.
   * 
   * @param value
   */
  ...
  /**
   * Method ERROR_FIELD_NOT_A_DOUBLE=| La valeur {0} du champ n est pas un reel
   * long.
   * 
   * @param value
   */
  ...
  /**
   * Method ERROR_FIELD_NOT_A_DATETIME=| La valeur {0} du champ n est pas une
   * date heure de format {1}.
   * 
   * @param value
   * @param dateformat
   * @return String
