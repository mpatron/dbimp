...
public class ReportTrigger implements Reporting {
  ...
  public ReportTrigger(BufferedWriter bw, ReportTypeLine reportTypeLine, Trigger trigger) {
    this.bw = bw;
  ...
  public void ERROR_TRIGGER(String message) {
    ...
    internalBuffer.append(RessourceReporting.getString("ERROR_TRIGGER", new Object[] { message }));
    used = true;
  }
