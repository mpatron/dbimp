...
public class ReportTypeLine implements Reporting {
  ...
  public ReportTypeLine(Report reporting, Line line) throws IOException {
    ...
    reportLineTmpFile = File.createTempFile("bimptypetine_" + line.getName(), ".txt");
    ...
    if (line.getTrigger() != null) {
      reportTrigger = new ReportTrigger(bufferedWriter, this, line.getTrigger());
    }
  }
  ...
  public void write() throws IOException {
    ...
    if ((reportTrigger != null) && reportTrigger.isUsed()) {
      ...
      if (getReportLine().getNumberLine() == 0) {
        ...
        bufferedWriter
            .write("|    " + RessourceReporting.getString("ERROR_TRIGGER_ON_LINE") + " : " + getReportLine().getNumberLine() + " :");
      }
      reportTrigger.write();
  ...
  public String writeEnd() throws IOException {
    ...
    sb.append("|");
    sb.append(System.lineSeparator());
    sb.append("|    " + RessourceReporting.getString("INFO_NUMBER_OF_SELECT") + "     : " + nbSelected);
    sb.append(System.lineSeparator());
    sb.append("|    " + RessourceReporting.getString("INFO_NUMBER_OF_INSERT") + "      : " + nbInsert);
    sb.append(System.lineSeparator());
    sb.append("|    " + RessourceReporting.getString("INFO_NUMBER_OF_UPDATE") + "      : " + nbUpdate);
    sb.append(System.lineSeparator());
    sb.append("|    " + RessourceReporting.getString("INFO_NUMBER_OF_DELETE") + "     : " + nbDelete);
    sb.append(System.lineSeparator());
  ...
  /**
   * @return ReportLineTmpFile, soit le fichier temporaire du rapport de ligne.
   */
