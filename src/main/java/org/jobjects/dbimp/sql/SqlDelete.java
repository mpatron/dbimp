...
public class SqlDelete extends SqlStatement {
  ...
  public String createSQL() throws SQLException {
    String returnValue = "delete from " + getSQLSchemaName() + getXmlline().getTableName();
    String where = "";
  ...
  public int execute(int nbLigne) {
    ...
    try {
      if (getXmlline().getTrigger() != null) {
        ...
        flag = getXmlline().getTrigger().beforeDelete(getConnection(), nbLigne, getReportTypeLine().getReportTrigger(), getXmlline());
      }
