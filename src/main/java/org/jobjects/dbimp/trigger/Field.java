...
/**
 * Tag field. Utilisé lors de la lecture du fichier par les trigger.
 * 
...
public interface Field {
  ...
  /**
   * Spécifie le contenu du buffer. Attention c'est à partir du contenu du
   * buffer que les modifications sont apportés à la base donnée.
   * 
   * @param buffer
   */
