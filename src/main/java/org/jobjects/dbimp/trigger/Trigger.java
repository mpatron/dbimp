...
/** Interface à implémenté afin de pourvoir executer des actions
...
public interface Trigger {
	...
	/** L'action sera déclanché avant la lecture de la première ligne.
	 * Utiliser field.buffer afin d'avoir la valeur sous la forme d'une chaine.
	 * @param connection Connection en cour.
	 * @param nbLigne Numéro de ligne du fichier en cours de lecture.
	...
	/** L'action sera déclanché après la lecture de la dernière ligne.
	 * Utiliser field.buffer afin d'avoir la valeur sous la forme d'une chaine.
	 * @param connection Connection en cour.
	 * @param nbLigne Numéro de ligne du fichier en cours de lecture.
	 * @param report Rapport d'importation.
	...
	/** L'action sera déclanché avant l'insertion de la ligne en cours.
   * Utiliser field.buffer afin d'avoir la valeur sous la forme d'une chaine.
   * @param connection Connection en cour.
	 * @param nbLigne Numéro de ligne du fichier en cours de lecture.
	 * @param report Rapport d'importation.
	...
	/** L'action sera déclanché après l'insertion de la ligne en cours.
   * Utiliser field.buffer afin d'avoir la valeur sous la forme d'une chaine.
   * @param connection Connection en cour.
	 * @param nbLigne Numéro de ligne du fichier en cours de lecture.
	 * @param report Rapport d'importation.
	...
	/** L'action sera déclanché avant la mise à jour de la ligne en cours.
   * Utiliser field.buffer afin d'avoir la valeur sous la forme d'une chaine.
   * @param connection Connection en cour.
	 * @param nbLigne Numéro de ligne du fichier en cours de lecture.
	 * @param report Rapport d'importation.
	...
	/** L'action sera déclanché après la mise à jour de la ligne en cours.
   * Utiliser field.buffer afin d'avoir la valeur sous la forme d'une chaine.
   * @param connection Connection en cour.
	 * @param nbLigne Numéro de ligne du fichier en cours de lecture.
	 * @param report Rapport d'importation.
	...
	/** L'action sera déclanché avant la suppression de la ligne en cours.
   * Utiliser field.buffer afin d'avoir la valeur sous la forme d'une chaine.
   * @param connection Connection en cour.
	 * @param nbLigne Numéro de ligne du fichier en cours de lecture.
	 * @param report Rapport d'importation.
	...
	/** L'action sera déclanché après la suppression de la ligne en cours.
   * Utiliser field.buffer afin d'avoir la valeur sous la forme d'une chaine.
   * @param connection Connection en cour.
	 * @param nbLigne Numéro de ligne du fichier en cours de lecture.
	 * @param report Rapport d'importation.
