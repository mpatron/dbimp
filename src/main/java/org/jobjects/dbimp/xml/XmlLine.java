...
/**
 * Tag line. Utilisé dans la lecture du fichier de paramètrage.
 * 
...
public class XmlLine implements Line {
  ...
  /**
   * trigger prend la valeur null. action prend la valeur INSERT_UPDATE.
   * 
   * @param name
   * @param tableName
   */
   ...
   */
  private Deque<Field> fields = new LinkedList<Field>();
